    ...
    <footer className="bg-gray-100 mt-5">
      ...
      <div className="mx-auto max-w-5xl px-4 py-16 sm:px-6 lg:px-8">
        <div className="flex justify-center text-teal-600">
          <Image alt='slas' src='/IMG_20240429_142206.png' width={200} height={150}/>
        </div>

        <p className="mx-auto mt-6 max-w-md text-center leading-relaxed text-gray-500">
          All trademarks associated with SkyLine and all intellectual property rights therein are owned by Kareem Co and may only be used with prior permission.
        </p>
